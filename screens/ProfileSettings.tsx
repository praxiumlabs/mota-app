/**
 * =====================================================
 * MOTA PROFILE & SETTINGS SYSTEM - FIXED VERSION
 * =====================================================
 */
...
export const PermissionsModal = ({ 
  ...
  const safeCallback = () => {
    if (typeof onComplete === 'function') {
      onComplete();
    } else if (typeof onGranted === 'function') {
      onGranted();
    } else if (typeof onClose === 'function') {
      onClose();
    } else {
      console.log('No callback provided to PermissionsModal');
    }
  };
  ...
  const checkPermissions = async () => {
    try {
      ...
      setBluetoothStatus('granted'); // Simplified for demo
    } catch (error) {
      ...
      <View style={permStyles.container}>
        ...
        <View style={permStyles.notice}>
          ...
          <Text style={permStyles.noticeText}>
            These permissions are mandatory for accurate on-site notifications.
          </Text>
        </View>
        ...
        {locationStatus === 'denied' && (
          <TouchableOpacity style={permStyles.refreshBtn} onPress={checkPermissions}>
            ...
            <Text style={permStyles.refreshText}>Check again</Text>
          </TouchableOpacity>
        )}
        ...
        <TouchableOpacity style={permStyles.skipBtn} onPress={safeCallback}>
...
export const AccountDeletionModal = ({ visible, onClose, onDelete }: {
  ...
  const handleDelete = () => {
    ...
    if (selectedOption) onDelete(selectedOption);
  };
          ...
          <View style={deleteStyles.options}>
            ...
            >
              ...
              <View style={deleteStyles.optionContent}>
                ...
                <Text style={deleteStyles.optionDesc}>Temporarily deactivate. Reactivate by logging in.</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={deleteStyles.optionContent}>
                ...
                <Text style={deleteStyles.optionDesc}>Cannot be undone.</Text>
              </View>
            </TouchableOpacity>
          ...
          <View style={deleteStyles.footer}>
            ...
            >
              <Text style={deleteStyles.deleteText}>
                {selectedOption === 'deactivate' ? 'Deactivate' : 'Delete'}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
...
const deleteStyles = StyleSheet.create({
  ...
  optionRadio: { width: 24, height: 24, borderRadius: 12, borderWidth: 2, borderColor: C.textMuted, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  ...
  optionDesc: { fontSize: 13, color: C.textMuted },
  confirmInput: { backgroundColor: C.card, borderRadius: 10, padding: 14, color: C.text, fontSize: 16, textAlign: 'center', borderWidth: 1, borderColor: C.error, marginTop: 8 },
